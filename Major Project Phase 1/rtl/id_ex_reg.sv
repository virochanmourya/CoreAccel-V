...
//     - EX group:  alu_src, alu_control  (used in EX stage) --> src ---> source register
...
module id_ex_reg (
    ...
    input  logic        reset,
    input  logic        flush,
    input  logic        stall, // NEW: Hardware Freeze Capability
    ...
    always_ff @(posedge clk) begin
        if (reset || flush) begin
            ...
            // NEW: HOLD STATE! Do absolutely nothing. 
            // The registers will safely retain their current values.
